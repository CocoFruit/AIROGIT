...
class CommitMessageEditor(QtWidgets.QFrame):
    ...
    def __init__(self, context, parent):
        ...
        qtutils.connect_button(self.autofill_button, self.summary.autofill_summary)
...
class CommitSummaryLineEdit(SpellCheckLineEdit):
    ...
    def autofill_summary(self):
        ...
        summary = new_summarize_changes(git_diff=diff.new_diff_text, template=template, verbose=True)
        print(summary)
